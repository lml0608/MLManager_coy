...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private static final String TAG_DBG = "MainActivity_dbg";
    ...
    class getInstalledApps extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            for (PackageInfo packageInfo : packages) {
                ...
                actualApps++;
                Log.i(TAG, String.valueOf(actualApps));
                Log.i(TAG, String.valueOf(hiddenApps.size()));//0
            ...
            for (String app : hiddenApps) {
                ...
                actualApps++;
                //Log.i(TAG_DBG, String.valueOf(hiddenApps.size()));
                publishProgress(Double.toString((actualApps * 100) / totalApps));
            }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            recyclerView.addOnScrollListener(fastScroller.getOnScrollListener());//OnScrollListener(fastScroller.getOnScrollListener());
